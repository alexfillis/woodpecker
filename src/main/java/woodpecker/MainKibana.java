    ...
    private void run(String[] args) {
        try {
            ...
            WebServer webServer = WebServers.createWebServer(config.getInt("http.port", 8080))
                    .add(new StaticFileHandler("/home/alex/apps/kibana-3.1.0"))
